...
```bash
make -C post_training/dqs_preference_training_hf dry-run-cpo
make -C post_training/dqs_preference_training_hf smoke-cpo MODEL_DIR=/workspace/models/sft_final
make -C post_training/dqs_preference_training_hf train-cpo MODEL_DIR=/workspace/models/sft_final
```

```bash
make -C post_training/dqs_preference_training_hf dry-run-dpo
make -C post_training/dqs_preference_training_hf smoke-dpo MODEL_DIR=/workspace/models/sft_final
make -C post_training/dqs_preference_training_hf train-dpo MODEL_DIR=/workspace/models/sft_final
```
